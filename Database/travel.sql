...
--
-- Host: 127.0.0.1
-- Generation Time: May 30, 2017 at 08:51 PM
...
(7, 'ab', '7894561236', 'vivek@gmail.com', 'asd');
...
(16, 1, 'vivek', 'Male', '9674428147', 'viveksome@gmail.com', 3, 2, 2, 'how to book?', 'Pending'),
(17, 3, 'viv', 'male', '9595959595', 'abc', 2, 1, 1, 'mm', 'Pending'),
(26, 15, 'Krishna', 'male', '9696969696', 'krishna@gmail.com', 8, 1, 1, 'How', 'Pending'),
(29, 17, 'krishna ', 'male', '9830546723', 'krisharma096@gmail.com', 1, 1, 1, 'hii bro ', 'Confirm'),
(32, 16, 'Joe', 'male', '258369147', 'joe@gmail.com', 20, 1, 1, 'Wow,  call me soon', 'Pending');
...
INSERT INTO `review` (`Name`, `Review`, `rid`) VALUES
('keviv', 'excellent service', 1),
('ram', 'very nice and prompt service', 2),
('shyam', 'i feel so special after the type of service they provided Excellent', 3),
('ghanshyam', 'i like it Five stars', 4),
('Rajuram', 'Its better than anything i have seen so far', 5);
...
INSERT INTO `sentbox` (`Name`, `Messages`, `mid`) VALUES
('Navneet', 'abra', 1),
('admin', 'we are happy to help. Give us a call', 2),
('admin', 'test. mike test', 3),
('admin', 'sdfsgfx', 4),
('vivek', 'gdrgdrg', 5);
...
INSERT INTO `users` (`Username`, `Pwd`, `Typeofuser`, `email`, `uid`) VALUES
('admin', 'admin', 'Admin', 'viveksome@gmail.com', 1),
('neeru', 'neeru', 'General', 'abc@gmail.com', 2),
('manu', '12345', 'Admin', '123@gmail.com', 3),
('preet', 'preet', 'General', 'dfgg@jdfjks.com', 4),
('vivek', 'amartyas', 'Admin', 'haha@gmail.com', 7),
('Amartya', 'amartyad', 'General', 'amartya@gmail.com', 9),
('Qwer', 'qwer', '', 'qwer', 10),
('Asd', 'asd', '', 'Asd', 19);
...
--
ALTER TABLE `enquiry`
  MODIFY `Enquiryid` int(50) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=33;
--
...
--
-- AUTO_INCREMENT for table `sentbox`
--
ALTER TABLE `sentbox`

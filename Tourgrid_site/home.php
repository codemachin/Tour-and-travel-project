	     ...
	     <div id="portfoliolist">
					<div class="portfolio card mix_all" data-cat="card" style="display: inline-block; opacity: 1;">
						<div class="portfolio-wrapper wow bounceIn" data-wow-delay="0.4s">		
							<a href="detail.php?pid=15" class="b-link-stripe b-animate-go  thickbox play-icon popup-with-zoom-anim">
...
<div class="client-say">
	 <div class="client-say-layer">
	     <div class="client-say-head text-center">
			 ...
			 <?php				
				$s="select * from review order by rid desc limit 5";
                $result=mysqli_query($cn,$s);
				
				while($data=mysqli_fetch_array($result)): ?>
				<div class="item">
					  <div class="client-say-info">
							<p><img src="images/dots1.png" alt="#"><?php echo $data[1]; ?><img src="images/dots2.png" alt="#"></p>
		  ...
		  <div class="contact-grids">
			  <div class="container">
				  <div class="col-md-4 address">
						<h4 style="color:#09F">Tourgrid travel agency</h4>
						...
						<h5 style="color:#000"><span class="img2"></span><a href="#">info@tourgrid.com&nbsp;&nbsp;&nbsp;-&nbsp;&nbsp;&nbsp;support@tourgrid.com</a></h5>
						<h5 style="color:#000"><span class="img3"></span>sec-5,salt lake ,kol-64</h5>
                        <br/>

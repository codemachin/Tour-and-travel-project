...
{
	$cn=makeconnection();
	$s="update users set pwd='" . $_POST["t2"] ."',email='" . $_POST["e1"] ."',Typeofuser='" . $_POST["s1"] . "' where Username='" . $_POST["t1"] . "'";
	mysqli_query($cn,$s);
	mysqli_close($cn);
...
<tr><td class="lefttxt">Email</td><td><input type="email" name="e1"  title"Please Enter Only Characters and numbers and alphabets" /></td></tr>

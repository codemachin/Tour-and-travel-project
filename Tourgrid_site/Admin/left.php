<?php if(!isset($_SESSION)) { session_start(); require_once 'dbconnect.php';} 
...
<tr><td style="font-size:28px">To Do Links</td></tr>
...
<tr><td><a href="Mymessages.php">Manage Messages</a></td></tr>

<?php }?>

<tr><td><a href="addreview.php">Add Review</a></td></tr>
...
<?php }?>
<tr><td><a href="viewenquiry by user.php">View Enquiry by <?php echo $_SESSION['username']; ?></a></td></tr>
</table>
